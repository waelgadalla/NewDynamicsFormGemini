...
| 4 | Workflow Designer | 2 weeks | Node canvas, connections, workflow properties |
...
#### 4.5 Workflow Controls
- [ ] WfZoomControls (zoom in, out, fit)
- [ ] WfMinimap (overview with viewport indicator)
- [ ] Add node menu

#### 4.6 Workflow Properties Panel
- [ ] WfPropertiesPanel
...
#### 4.7 Workflow State
- [ ] Workflow state in EditorStateService
...
### Expected Output
Complete workflow designer with node rendering and connections
```
